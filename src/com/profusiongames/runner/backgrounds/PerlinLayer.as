package com.profusiongames.runner.backgrounds 
{
	 ...
	 */
	public class PerlinLayer extends Sprite// Layer 
	{
		public var _renderTexture:RenderTexture;
		public var _layer:Sprite;
		public var _gradient:Image;
		public var _gradientSprite:flash.display.Sprite
		public var _gradientBitmap:Bitmap;
		public var perlinBitmap:Bitmap;
		...
		private function init(e:Event):void 
		{
			...
			var start:uint = 0x2F4F4F;
			var end:uint = 0x79CDCD;
			
			var q:Quad = new Quad(800, 600);
			q.setVertexColor(0, start);
			q.setVertexColor(1, end);
			q.setVertexColor(2, start);
			q.setVertexColor(3, end);
			addChild(q);
